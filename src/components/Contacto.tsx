	...
	return (
		<section className="h-screen" id="contacto">
			<div className="flex flex-col justify-center gap-16 pt-24 text-center">
				<h2 className="text-7xl font-semibold">Contacto</h2>
				<form
					action={handleForm}
					className="flex flex-wrap gap-9 rounded-md bg-white px-6 py-4 text-black"
				>
					<div className="flex w-full gap-9">
						<div className="flex w-1/3 flex-col gap-1 text-start">
					...
					<div className="flex w-full gap-9">
						...
						<button
							type="submit"
							className="h-min self-end rounded-md bg-[#2C2C2C] py-3 text-center text-white transition-colors duration-300 hover:bg-black"
						>
							Enviar
						</button>
					</div>
